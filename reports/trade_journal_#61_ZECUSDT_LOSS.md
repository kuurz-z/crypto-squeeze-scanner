# Trade Record & Post-Mortem Diagnostic #61: ZECUSDT (LONG)
*Closed on: 2026-08-21 00:57:10*

## 1. Trade Execution Summary
- **Outcome**: `LOSS`
- **Realized PnL**: `$-1.08 USD` (-1.08 R)
- **Resulting Account Balance**: `$46.75 USD`
- **Entry Price**: `$587.52` | **Exit Price**: `$572.84`
- **Stop Loss**: `$572.84` | **Take Profit**: `$624.23` (1:2.5 RR)
- **Position Size**: `0.0681 units` (Notional Value: `$40.01`)
- **Max Favorable Excursion (MFE)**: `+0.57 R`
- **Max Adverse Excursion (MAE)**: `-1.24 R`
...
- **Relative Volume Surge (RVOL)**: `2.95x` (vs 20-bar SMA)
- **RSI (14)**: `71.3`
- **Momentum Oscillator**: `8.3394`
