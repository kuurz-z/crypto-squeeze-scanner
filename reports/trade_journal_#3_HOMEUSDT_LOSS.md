# Trade Record & Post-Mortem Diagnostic #3: HOMEUSDT (LONG)
*Closed on: 2026-08-20 18:25:52*

## 1. Trade Execution Summary
- **Outcome**: `LOSS`
- **Realized PnL**: `$-1.08 USD` (-1.08 R)
- **Resulting Account Balance**: `$96.76 USD`
- **Entry Price**: `$0.00625` | **Exit Price**: `$0.006178`
- **Stop Loss**: `$0.006178` | **Take Profit**: `$0.006394` (1:2.0 RR)
- **Position Size**: `13888.8889 units` (Notional Value: `$86.81`)
- **Max Favorable Excursion (MFE)**: `+0.0 R`
- **Max Adverse Excursion (MAE)**: `-1.11 R`
...
- **Relative Volume Surge (RVOL)**: `1.47x` (vs 20-bar SMA)
- **RSI (14)**: `67.5`
- **Momentum Oscillator**: `0.0`
- **Volatility (ATR14)**: `0.0001`
