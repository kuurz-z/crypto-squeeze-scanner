...
*Generated on: 2026-08-20 17:35:30*

## 1. Executive Summary
- **Strategy Name**: `Squeeze_Momentum_Breakout`
- **Optimal Timeframe Selected**: `1h` (Evaluated: 5m, 15m, 1h)
...
- **Timeframe**: `1h`
- **Tested Out-of-Sample Trades**: `25`
- **Win Rate**: `80.0%`
- **Net Expectancy**: `+1.72 R`
- **Total Net Return**: `43.0 R`
