# Trade Record & Post-Mortem Diagnostic #26: BICOUSDT (LONG)
*Closed on: 2026-08-20 21:27:55*

## 1. Trade Execution Summary
- **Outcome**: `LOSS`
- **Realized PnL**: `$-1.08 USD` (-1.08 R)
- **Resulting Account Balance**: `$74.76 USD`
- **Entry Price**: `$0.0185` | **Exit Price**: `$0.017747`
- **Stop Loss**: `$0.017747` | **Take Profit**: `$0.020382` (1:2.5 RR)
- **Position Size**: `1328.0212 units` (Notional Value: `$24.57`)
- **Max Favorable Excursion (MFE)**: `+0.25 R`
- **Max Adverse Excursion (MAE)**: `-1.09 R`
