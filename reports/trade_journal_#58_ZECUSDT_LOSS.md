# Trade Record & Post-Mortem Diagnostic #58: ZECUSDT (LONG)
*Closed on: 2026-08-21 00:56:02*

## 1. Trade Execution Summary
- **Outcome**: `LOSS`
- **Realized PnL**: `$-1.08 USD` (-1.08 R)
- **Resulting Account Balance**: `$49.99 USD`
- **Entry Price**: `$588.5` | **Exit Price**: `$573.82`
- **Stop Loss**: `$573.82` | **Take Profit**: `$625.21` (1:2.5 RR)
