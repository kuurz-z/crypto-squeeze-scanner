# Trade Record & Post-Mortem Diagnostic #63: ZECUSDT (LONG)
*Closed on: 2026-08-21 00:57:55*

## 1. Trade Execution Summary
- **Outcome**: `LOSS`
- **Realized PnL**: `$-1.08 USD` (-1.08 R)
- **Resulting Account Balance**: `$44.59 USD`
- **Entry Price**: `$587.51` | **Exit Price**: `$572.83`
- **Stop Loss**: `$572.83` | **Take Profit**: `$624.22` (1:2.5 RR)
- **Position Size**: `0.0681 units` (Notional Value: `$40.01`)
- **Max Favorable Excursion (MFE)**: `+0.58 R`
- **Max Adverse Excursion (MAE)**: `-1.23 R`
...
- **Relative Volume Surge (RVOL)**: `2.96x` (vs 20-bar SMA)
- **RSI (14)**: `71.3`
- **Momentum Oscillator**: `8.3386`
