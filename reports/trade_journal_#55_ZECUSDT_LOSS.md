# Trade Record & Post-Mortem Diagnostic #55: ZECUSDT (LONG)
*Closed on: 2026-08-21 00:54:53*

## 1. Trade Execution Summary
- **Outcome**: `LOSS`
- **Realized PnL**: `$-1.08 USD` (-1.08 R)
- **Resulting Account Balance**: `$53.23 USD`
- **Entry Price**: `$588.52` | **Exit Price**: `$573.84`
- **Stop Loss**: `$573.84` | **Take Profit**: `$625.23` (1:2.5 RR)
- **Position Size**: `0.0681 units` (Notional Value: `$40.08`)
- **Max Favorable Excursion (MFE)**: `+0.51 R`
- **Max Adverse Excursion (MAE)**: `-1.3 R`
...
- **Relative Volume Surge (RVOL)**: `2.94x` (vs 20-bar SMA)
- **RSI (14)**: `71.7`
- **Momentum Oscillator**: `8.4207`
