# Trade Record & Post-Mortem Diagnostic #45: ZECUSDT (LONG)
*Closed on: 2026-08-21 00:51:04*

## 1. Trade Execution Summary
- **Outcome**: `LOSS`
- **Realized PnL**: `$-1.08 USD` (-1.08 R)
- **Resulting Account Balance**: `$64.03 USD`
- **Entry Price**: `$586.97` | **Exit Price**: `$572.29`
- **Stop Loss**: `$572.29` | **Take Profit**: `$623.68` (1:2.5 RR)
- **Position Size**: `0.0681 units` (Notional Value: `$39.97`)
- **Max Favorable Excursion (MFE)**: `+0.61 R`
- **Max Adverse Excursion (MAE)**: `-1.2 R`
...
- **Relative Volume Surge (RVOL)**: `2.89x` (vs 20-bar SMA)
- **RSI (14)**: `71.0`
- **Momentum Oscillator**: `8.2947`
