# Trade Record & Post-Mortem Diagnostic #53: ZECUSDT (LONG)
*Closed on: 2026-08-21 00:54:07*

## 1. Trade Execution Summary
- **Outcome**: `LOSS`
- **Realized PnL**: `$-1.08 USD` (-1.08 R)
- **Resulting Account Balance**: `$55.39 USD`
- **Entry Price**: `$587.85` | **Exit Price**: `$573.17`
- **Stop Loss**: `$573.17` | **Take Profit**: `$624.56` (1:2.5 RR)
- **Position Size**: `0.0681 units` (Notional Value: `$40.03`)
- **Max Favorable Excursion (MFE)**: `+0.55 R`
- **Max Adverse Excursion (MAE)**: `-1.26 R`
