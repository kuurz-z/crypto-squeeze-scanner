# Trade Record & Post-Mortem Diagnostic #4: HOMEUSDT (LONG)
*Closed on: 2026-08-20 18:26:14*

## 1. Trade Execution Summary
- **Outcome**: `LOSS`
- **Realized PnL**: `$-1.08 USD` (-1.08 R)
- **Resulting Account Balance**: `$95.68 USD`
...
- **Relative Volume Surge (RVOL)**: `1.48x` (vs 20-bar SMA)
- **RSI (14)**: `67.5`
