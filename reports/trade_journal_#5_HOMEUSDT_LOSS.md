# Trade Record & Post-Mortem Diagnostic #5: HOMEUSDT (LONG)
*Closed on: 2026-08-20 18:26:37*

## 1. Trade Execution Summary
- **Outcome**: `LOSS`
- **Realized PnL**: `$-1.08 USD` (-1.08 R)
- **Resulting Account Balance**: `$94.60 USD`
...
- **Max Favorable Excursion (MFE)**: `+0.14 R`
...
- **Relative Volume Surge (RVOL)**: `1.5x` (vs 20-bar SMA)
- **RSI (14)**: `67.5`
