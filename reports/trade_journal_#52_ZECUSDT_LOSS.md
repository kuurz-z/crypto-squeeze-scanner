# Trade Record & Post-Mortem Diagnostic #52: ZECUSDT (LONG)
*Closed on: 2026-08-21 00:53:44*

## 1. Trade Execution Summary
- **Outcome**: `LOSS`
- **Realized PnL**: `$-1.08 USD` (-1.08 R)
- **Resulting Account Balance**: `$56.47 USD`
- **Entry Price**: `$588.15` | **Exit Price**: `$573.47`
- **Stop Loss**: `$573.47` | **Take Profit**: `$624.86` (1:2.5 RR)
- **Position Size**: `0.0681 units` (Notional Value: `$40.05`)
- **Max Favorable Excursion (MFE)**: `+0.53 R`
- **Max Adverse Excursion (MAE)**: `-1.28 R`
...
- **Relative Volume Surge (RVOL)**: `2.93x` (vs 20-bar SMA)
- **RSI (14)**: `71.5`
- **Momentum Oscillator**: `8.3906`
- **Volatility (ATR14)**: `10.4886`
