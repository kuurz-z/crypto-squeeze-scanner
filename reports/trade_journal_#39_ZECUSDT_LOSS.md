# Trade Record & Post-Mortem Diagnostic #39: ZECUSDT (LONG)
*Closed on: 2026-08-21 00:31:18*

## 1. Trade Execution Summary
- **Outcome**: `LOSS`
- **Realized PnL**: `$-1.08 USD` (-1.08 R)
- **Resulting Account Balance**: `$69.17 USD`
- **Entry Price**: `$583.57` | **Exit Price**: `$569.9`
- **Stop Loss**: `$569.9` | **Take Profit**: `$617.74` (1:2.5 RR)
- **Position Size**: `0.0732 units` (Notional Value: `$42.72`)
- **Max Favorable Excursion (MFE)**: `+0.16 R`
- **Max Adverse Excursion (MAE)**: `-1.04 R`
...
- **Relative Volume Surge (RVOL)**: `1.33x` (vs 20-bar SMA)
- **RSI (14)**: `69.6`
- **Momentum Oscillator**: `8.2301`
